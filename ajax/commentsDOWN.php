...
$request="SELECT * FROM view_account_comments WHERE account_comments_target='{$_GET['u']}' AND account_comments_type=0 AND account_comments_replay_target IS NULL AND deleted=0";
...
$request2="SELECT * FROM view_account_comments WHERE account_comments_replay_target=".$row['account_comments_id']." AND account_comments_target IS NULL AND deleted=0 ORDER BY account_comments_id ASC";
